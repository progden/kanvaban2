...
| T2.04 | blocked | [F02] 定案 `s-board-list`（類型：列表）：對應 `uc-view-board-list`；無權限狀態對應 `uc-reject-board-access-by-nonmember` | 同上 | T2.03 |
