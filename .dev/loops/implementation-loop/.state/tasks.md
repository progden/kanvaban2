...
| T-11-fe-auth | `s-login`、`s-signup` | T-10-fe-shell | doing | 2026-09-18 Review 第 1 輪退回（見 `review.md`）：待處理 D-05～D-07；OQ-IMPL-12（設計稿無法存取，先用純語意版面）待處理，不影響操作／驗收條件行為 |
